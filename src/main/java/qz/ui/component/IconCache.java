...
public class IconCache {
    ...
    public enum Icon {
        // Tray icons
        DEFAULT_ICON("qz-ui-default.png", "qz-ui-default-20.png", "qz-ui-default-24.png", "qz-ui-default-32.png", "qz-ui-default-40.png", "qz-default-48.png"),
        WARNING_ICON("qz-ui-warning.png", "qz-ui-warning-20.png", "qz-ui-warning-24.png", "qz-ui-warning-32.png", "qz-ui-warning-40.png", "qz-warning-48.png"),
        DANGER_ICON("qz-ui-danger.png", "qz-ui-danger-20.png", "qz-ui-danger-24.png", "qz-ui-danger-32.png", "qz-ui-danger-40.png", "qz-danger-48.png"),
        ...
        TASK_BAR_ICON("qz-ui-default.png#", "qz-ui-default-20.png#", "qz-ui-default-24.png#", "qz-ui-default-32.png#", "qz-ui-default-40.png#", "qz-default-48.png#"),

        // Menu Item icons
        EXIT_ICON("qz-ui-exit.png"),
        RELOAD_ICON("qz-ui-reload.png"),
        ABOUT_ICON("qz-ui-about.png"),
        DESKTOP_ICON("qz-ui-desktop.png"),
        SAVED_ICON("qz-ui-saved.png"),
        LOG_ICON("qz-ui-log.png"),
        FOLDER_ICON("qz-ui-folder.png"),
        SETTINGS_ICON("qz-ui-settings.png"),

        // Dialog icons
        ALLOW_ICON("qz-ui-allow.png"),
        BLOCK_ICON("qz-ui-block.png"),
        CANCEL_ICON("qz-ui-cancel.png"),
        TRUST_VERIFIED_ICON("qz-trust-verified.png"),
        TRUST_ISSUE_ICON("qz-trust-issue.png"),
        TRUST_MISSING_ICON("qz-trust-missing.png"),
        FIELD_ICON("qz-ui-field.png"),
        DELETE_ICON("qz-ui-delete.png"),
        QUESTION_ICON("qz-ui-question.png"),

        // Banner
        LOGO_ICON("qz-logo.png"),
        BANNER_ICON("qz-ui-banner.png");
