...
#define MyAppVersion "1.7.0" ;this line is populated automatically, don't remove it
...
UsePreviousGroup=no
OutputBaseFilename=embrace_server_bridge-1_7_0-windows-x64
Compression=lzma
...
[Files]
Source: "bundle\EmbraceServerBridge\*";DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "include\*";DestDir: "{app}"; Flags: ignoreversion recursesubdirs
Source: "COPYING";DestDir: "{app}"; 

[InstallDelete]
Type: files; Name: "{app}\app\javafx*.jar"
